    ...
    return Padding(
      ...
      child: new TextFormField(
        ...
        decoration: new InputDecoration(
            hintText: 'you@ejemplo.com',
            labelText: 'Correo electrónico',
            icon: new Icon(
              Icons.mail,
              color: Colors.grey,
            )),
        validator: (value) => value.isEmpty ? 'El correo no puede estar vacio' : null,
  ...
  Widget _showPasswordInput() {
    return Padding(
      ...
      child: new TextFormField(
        ...
        validator: (value) => value.isEmpty ? 'El password no puede estar vacía' : null,
  ...
  Widget _showSecondaryButton() {
    return new FlatButton(
      child: _formMode == FormMode.LOGIN
          ...
          : new Text('¿Tienes una cuenta? Registrarse',
              style:
